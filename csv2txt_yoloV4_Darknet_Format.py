...
f = open("C:/Users/XXXXX/Downloads/Self-Driving Cars_archive/csv2txt_darknet_formatting/labels_train.csv", "r+")    #Comment above
...
for line in f:                              #reads line by line
    ...
    if (previousLabel in currentLine[0]):                   #checks to see if label is the same as the last line
        ...
        modifiedCurrLine = str(currentLine[:-1])                #removes class ID data
